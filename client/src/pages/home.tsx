...
import problemImage from "@assets/generated_images/exact_flat_dark_red_ionic_column_icon_with_crack.png";
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
             <div className="order-2 md:order-1 relative flex justify-center">
                <img 
                  ...
                  className="relative z-10 w-3/4 max-w-xs mix-blend-multiply hover:scale-105 transition-all duration-500"
                />
             </div>
