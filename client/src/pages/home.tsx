...
export default function Home() {
  ...
  return (
    <Layout>
      {/* Chapter 1: The Context (Hero + Problem) */}
      <div className="relative group chapter-context">
        {/* Hero Section */}
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pb-16">
          ...
          {/* Organic Curve Transition - Anchored to bottom, high z-index */}
          <div className="absolute bottom-[-1px] left-0 w-full h-16 md:h-24 pointer-events-none z-30 leading-none">
             <svg className="w-full h-full text-muted/30 fill-current block" viewBox="0 0 1440 100" preserveAspectRatio="none">
               <path d="M0,100 C480,0 960,0 1440,100 Z" />
             </svg>
          </div>
        </section>

        {/* Problem Section (Part of Context Chapter) */}
        <div className="bg-muted/30 relative">
          ...
          {/* Soft Fade to Next Chapter (Dark) */}
          <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-b from-transparent to-black/10 pointer-events-none" />
        </div>
      </div>

      {/* Chapter 2: The Vision (Hope + Definition) */}
      <div className="relative group chapter-vision">
        ...
        <section className="relative pt-40 pb-20 flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-black/80 to-transparent opacity-80" />
          </div>
        ...
        {/* What is Mosaic Section - Flowing from Hope */}
        <section className="py-24 bg-gradient-to-b from-white to-slate-50 relative">
           {/* Top fade from Hope section (Dark to Light transition helper) */}
      ...
      <div className="relative group chapter-mechanics">
        {/* How Mosaic Works - Deep Blue Band */}
        <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
          <div className="absolute inset-0 bg-pattern-mesh opacity-[0.1]" />
          {/* Subtle top shadow */}
          <div className="absolute top-0 left-0 w-full h-12 bg-gradient-to-b from-black/20 to-transparent" />
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
              ...
              <div className="flex flex-col items-center text-center p-6 group">
                <div className="mb-6 text-mosaic-gold transform group-hover:scale-110 transition-transform duration-300">
                  <Database size={52} strokeWidth={1.5} />
                </div>
              ...
              <div className="flex flex-col items-center text-center p-6 group">
                <div className="mb-6 text-mosaic-gold transform group-hover:scale-110 transition-transform duration-300 flex items-center justify-center h-[52px] w-[52px]">
                   <img src="/assets/icons/river-flow.svg" alt="River Flow" className="w-[52px] h-[52px] text-mosaic-gold" style={{ filter: 'brightness(0) saturate(100%) invert(77%) sepia(26%) saturate(1478%) hue-rotate(359deg) brightness(101%) contrast(106%)' }} />
                </div>
      ...
      {/* Chapter 4: The Community (Merged Audience & Process) */}
      <div className="relative group chapter-community bg-slate-50">
        
        {/* Top transition from Dark Blue */}
        <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-primary/10 to-transparent pointer-events-none z-10" />
        ...
        <section className="pt-24 pb-12 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
               {/* Creators Card */}
               <div className="group p-8 rounded-2xl bg-white/80 backdrop-blur-md border border-border/50 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
        ...
        {/* Process Section - Merged seamlessy */}
      ...
      <section id="get-involved" className="py-32 bg-primary text-primary-foreground text-center relative">
        {/* Top transition from Light Community section */}
